...
class CityServiceTest {
    ...
    @Test
    void TestGetItalianRegionsSuccess() {
    ...
    @Test
    void TestGetItalianProvincesByRegionSuccess() {
    ...
    @Test
    void TestGetItalianCitiesByProvinceSuccess() {
    ...
    @Test
    void TestGetCityNameByCodeSuccess() {
